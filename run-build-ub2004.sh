...
docker exec ub2004 apt install -y -qqq bash coreutils
...
docker exec ub2004 apt install -y -qqq coreutils binutils findutils util-linux sed gawk tar xz-utils gzip bzip2 file
